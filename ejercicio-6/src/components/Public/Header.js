      ...
      <div className="row">
        ...
        <div className="col-sm-4 offset-md-1 py-4">
          ...
          <ul className="list-unstyled">
            <li><a href="https://twitter.com/?lang=es" target='_blank' className="text-white">Follow on Twitter</a></li>
            <li><a href="https://www.facebook.com/Eliochamorro/" target='_blank' className="text-white">Like on Facebook</a></li>
            <li><a href="mailto:elio19.1991@gmail.com" className="text-white">Email me</a></li>
          </ul>
        </div>
      </div>
    </div>
